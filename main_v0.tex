...
\begin{figure}
  \centering
  \includegraphics[width=\textwidth]{figs/Fig_1.jpg}
...
\(\mathcal{X} \in \mathbb{R}^{\lvert \mathbf{V} \rvert \times T \times S}\) from the
...
\(\lvert \mathbf{V} \rvert \approx 75K\), \(T = 240\) is the number of time points,
...
\(\mathbf{a}_{i} \in \mathbb{R}^{\lvert \mathbf{V} \rvert}\) are the spatial network
...
feature matrix \(\mathbf{X \in}\mathbb{R}^{\lvert \mathbf{V} \rvert \times 50}\mathbf{\ (\lvert \mathbf{V} \rvert} \approx 75K)\).
...
\(\mathbf{A} = corr(\mathbf{X}) \in \mathbb{R}^{\lvert \mathbf{V} \rvert \times \lvert \mathbf{V} \rvert }\)
